...
var DataListInput = function (_React$Component) {
    _inherits(DataListInput, _React$Component);

    function DataListInput(props) {
        _classCallCheck(this, DataListInput);

        var _this = _possibleConstructorReturn(this, (DataListInput.__proto__ || Object.getPrototypeOf(DataListInput)).call(this, props));
        ...
        _this.onHandleInput = _this.onHandleInput.bind(_this);
        _this.match = _this.match.bind(_this);
        _this.indexOfMatch = _this.indexOfMatch.bind(_this);
        _this.onHandleKeydown = _this.onHandleKeydown.bind(_this);
    ...
    _createClass(DataListInput, [{
        key: 'onHandleInput',
        value: function onHandleInput(event) {
            var _this2 = this;

            var currentInput = event.target.value;
            var matchingItems = this.props.items.filter(function (item) {
                if (_typeof(_this2.props.match) === (typeof Function === 'undefined' ? 'undefined' : _typeof(Function))) return _this2.props.match(currentInput, item);
                return _this2.match(currentInput, item);
            });
            this.setState({
        ...
        key: 'match',
        value: function match(currentInput, item) {
        ...
        key: 'indexOfMatch',
        value: function indexOfMatch(currentInput, item) {
        ...
        key: 'onHandleKeydown',
        value: function onHandleKeydown(event) {
            // only do something if drop-down div is visible
            if (!this.state.visible) return;
            var currentFocusIndex = this.state.focusIndex;
            if (event.keyCode === 40 || event.keyCode === 9) {
                ...
                if (this.state.focusIndex > -1) {
                    ...
                    var selectedItem = this.state.matchingItems[currentFocusIndex];
        ...
        value: function onClickItem(event) {
            ...
            var selectedKey = event.currentTarget.children[1].value;
            var selectedItem = this.state.matchingItems.find(function (item) {
        ...
        key: 'onSelect',
        value: function onSelect(selectedItem) {
        ...
        value: function render() {
            ...
            var items = this.state.matchingItems;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { onKeyDown: this.onHandleKeydown, onInput: this.onHandleInput, type: 'text',
                    className: 'autocompleteInput',
                    placeholder: placeholder, value: currentInput }),
                currentInput !== "" && this.state.visible && _react2.default.createElement(
                    'div',
                    { className: "datalist-items" },
                    items.map(function (item, i) {
                        return _react2.default.createElement(
                            'div',
                            { onClick: _this3.onClickItem,
                                className: _this3.state.focusIndex === i ? " datalist-active-item" : undefined,
                                key: item.key },
                            item.label.substr(0, _this3.indexOfMatch(currentInput, item)),
                            _react2.default.createElement(
                                'strong',
                                null,
                                item.label.substr(_this3.indexOfMatch(currentInput, item), currentInput.length)
                            ),
                            item.label.substr(_this3.indexOfMatch(currentInput, item) + currentInput.length),
                            _react2.default.createElement('input', { type: 'hidden', value: item.key })
                        );
                    })
                )
            );
...
DataListInput.propTypes = {
    ...
    match: _propTypes2.default.func
};
