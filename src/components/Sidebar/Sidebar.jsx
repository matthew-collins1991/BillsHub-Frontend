  ...
  render() {
    ...
    var brand = (
      <div className={logoClasses}>
        <a href="https://www.downatthemac.proboards.com" className={logoMini}>
          <img src={logo} alt="logo" className={classes.img} />
        </a>
        <a href="https://www.downatthemac.proboards.com" className={logoNormal} style={{textTransform: 'none'}}>
          {logoText}
        </a>
      </div>
    );
